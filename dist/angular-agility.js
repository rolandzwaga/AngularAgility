/*
angular-agility v0.8.5 @ 2014-06-28T18:22:50
...
(function() {
    ...
    angular.module('aa.formDynamic')
        .provider('aaDynamicFormConfig', function () {
            ...
            this.defaultSelectStrategy = "select";
            this.defaultInputStrategy = "input";
            this.defaultRadioStrategy = "radio";
            ...
            this.$get = function() {
                return {
                    defaultSelectStrategy: _this.defaultSelectStrategy,
                    defaultInputStrategy: _this.defaultInputStrategy,
                    defaultRadioStrategy: _this.defaultRadioStrategy,
